...
> *Bringing diagnostic intelligence to the 4 billion people who have never seen a specialist.*
...
## Why Edge AI in Healthcare?

Rural health centers, community hospitals, and field health workers need AI diagnostics that work without cloud connectivity, process sensitive patient data locally, and provide instant results. A cloud-dependent TB screening tool that takes 10 minutes fails the health worker who needs an answer in 30 seconds before the patient walks out.

---

## Regulatory Landscape

Healthcare AI is regulated as a Software as a Medical Device (SaMD). Key bodies:

- **India:** CDSCO (Central Drugs Standard Control Organisation)
- **Global:** FDA (US), CE Mark (EU), WHO SMART Guidelines
